...
DESIGN= Car
CONFIG= debug
TOOLCHAIN_DIR ?= C:/Program Files (x86)/Cypress/PSoC Creator/4.4/PSoC Creator/import/gnu/arm/5.4.1/bin
...
CFLAGS_CortexM3= -mcpu=cortex-m3 -mthumb -I../util -I. -IGenerated_Source/PSoC5 -Wa,-alh=$(OUT_DIR_CortexM3)/$(basename $(<F)).lst -g -D DEBUG -D CY_CORE_ID=0 -Wall -ffunction-sections -ffat-lto-objects -Og
...
LDFLAGS_CortexM3= -mcpu=cortex-m3 -mthumb -l m -L Generated_Source/PSoC5 -Wl,-Map,$(OUT_DIR_CortexM3)/$(DESIGN).map -T Generated_Source/PSoC5/cm3gcc.ld -specs=nano.specs -Wl,--gc-sections -g -ffunction-sections -Og -ffat-lto-objects
